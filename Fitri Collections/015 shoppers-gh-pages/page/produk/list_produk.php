...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="list_produk.php">Fitri Admin</a>
            <!-- Sidebar Toggle-->
    ...
    $rs = $dbh->query($sql);
?>
<a class="btn btn-primary mb-2" href="form_produk.php" role="button">Create Produk</a>
<table class="table table-hover">
    <thead>
        <tr>
            <th>No</th><th>sku</th><th>Nama</th>
            <th>harga beli</th><th>harga jual</th>
            <th>stock</th><th>tipe</th><th>restock</th>
            <th>Action</th>
        </tr>
    </thead>
    <tbody>
