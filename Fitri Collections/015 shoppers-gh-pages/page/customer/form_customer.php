...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Fitri Collections</a>
            <!-- Sidebar Toggle-->
...
<form method="POST" action="proses_customer.php">
  <div class="form-group row mt-3">
    <label for="name" class="col-4 col-form-label h2" >Name</label> 
    <div class="col-8">
      <div class="input-group">
  ...
  <div class="form-group row mt-3">
    ...
    <div class="col-2">
      <div class="input-group">
        ...
        value="L" type="radio" class="form-check-input" required> Laki-laki
        <input id="gender" name="gender" 
        value="P" type="radio" class="form-check-input ms-2"> Perempuan
      </div>
    </div>
  </div>
  <div class="form-group row mt-3">
