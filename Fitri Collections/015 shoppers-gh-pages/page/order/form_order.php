...
<form method="POST" action="proses_order.php">
  <div class="form-group row mt-3">
    <label for="name" class="col-4 col-form-label h2" >Order Number</label> 
    <div class="col-8">
      <div class="input-group">
  ...
  <div class="form-group row mt-3">
    <label for="name" class="col-4 col-form-label h2" >Date</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row mt-3">
    <label for="phone" class="col-4 col-form-label h2">Qty</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row mt-3">
    <label for="email" class="col-4 col-form-label h2">Total Harga</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
 ...
 <div class="form-group row mt-3">
    <label for="Card" class="col-4 col-form-label h2">ID Customer</label> 
    <div class="col-8">
    <?php
  ...
  <div class="form-group row mt-3">
    <label for="Card" class="col-4 col-form-label h2">Product_id</label> 
    <div class="col-8">
    <?php
