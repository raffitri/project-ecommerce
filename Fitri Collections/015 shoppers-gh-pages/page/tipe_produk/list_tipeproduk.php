...
<html lang="en">
    ...
    $rs = $dbh->query($sql);
?>
<a class="btn btn-primary mb-2" href="form_tipeproduk.php" role="button">Create Produk Type</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-primary" href="view_tipeproduk.php?id=<?=$row['id']?>">View</a>
                <a class="btn btn-primary" href="form_tipeproduk.php?id=<?=$row['id']?>">Edit</a>
                <a class="btn btn-primary" href="delete_tipeproduk.php?id=<?=$row['id']?>"
                onclick="if(!confirm('Anda Yakin Hapus Data Tipe Produk <?=$row['id']?>?')) {return false}"
                                >Delete</a>
            </td>
        </tr>
        <?php 
